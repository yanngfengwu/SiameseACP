...
# batch_size = 128
# batch_size = 64# 这里用32会导致batch size到1
...
'''
nohup python train_and_test_AntiACP_Main.py > /mnt/sdb/home/yxt/CBC_and_DATA/result/M_lr=1e-4_epoch=300_nofreeze.log 2>&1 &
nohup python train_and_test_AntiACP_Main.py > /mnt/sdb/home/yxt/CBC_and_DATA/result/M_lr=1e-5_epoch=3000_nofreeze.log 2>&1 &
'''