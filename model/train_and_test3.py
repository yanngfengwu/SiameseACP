...
import pandas as pd
# 这个才是AAPred-CNN的，另一个train_and_test2是AAPred的
pep2label = list()
...
# train_data, train_label, train_seq = get_original_data("../dataset/AntiACP2.0/internal")
# test_data, test_label, test_seq = get_original_data("../dataset/AntiACP2.0/validation")
